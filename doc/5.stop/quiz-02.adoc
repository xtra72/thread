== Exam-02. Thread의 interrupt를 이용해 외부에서 중지하도록 만들어라.
...
* InterrupedException은 checked exception으로서 compile time에 처리 여부를 확인할 수 있도록 구성되어야 한다.
...
[source,java]
----
include::../../src/main/java/com/nhnacademy/stop/ThreadUnlimitedCounter.java[lines=19..21,indent=0]
----
--
+
